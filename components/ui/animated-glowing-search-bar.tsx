    ...
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[314px] rounded-xl blur-[3px]
                        ...
                        before:bg-[conic-gradient(#000,#1a5fa8_5%,#000_38%,#000_50%,#9333EA_60%,#000_87%)] before:transition-all before:duration-2000
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[3px]
                        ...
                        before:bg-[conic-gradient(rgba(0,0,0,0),#1a3a6a,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,#6b21a8,rgba(0,0,0,0)_60%)] before:transition-all before:duration-2000
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[307px] rounded-lg blur-[2px]
                        ...
                        before:bg-[conic-gradient(rgba(0,0,0,0)_0%,#7aa2d4,rgba(0,0,0,0)_8%,rgba(0,0,0,0)_50%,#b78cd4,rgba(0,0,0,0)_58%)] before:brightness-140
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[303px] rounded-xl blur-[0.5px]
                        ...
                        before:bg-[conic-gradient(#030305,#3ca2fa_5%,#030305_14%,#030305_50%,#9333EA_60%,#030305_64%)] before:brightness-130
        ...
        <div id="main" className="relative group">
          <input placeholder="Beschreiben Sie Ihr Problem..." type="text" name="text" className="bg-[#030305] border-none w-[301px] h-[56px] rounded-lg text-[#f5f5f7] px-[59px] text-lg focus:outline-none placeholder-gray-500" />
          <div id="input-mask" className="pointer-events-none w-[100px] h-[20px] absolute bg-gradient-to-r from-transparent to-[#030305] top-[18px] left-[70px] group-focus-within:hidden"></div>
          <div id="pink-mask" className="pointer-events-none w-[30px] h-[20px] absolute bg-[#9333EA] top-[10px] left-[5px] blur-2xl opacity-80 transition-all duration-2000 group-hover:opacity-0"></div>
          ...
          <div id="filter-icon" className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-[#161329] via-[#030305] to-[#1d1b4b] border border-transparent">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" height="24" fill="none" className="feather feather-search">
              ...
              <defs>
                <linearGradient gradientTransform="rotate(50)" id="search">
                  <stop stopColor="#f5f5f7" offset="0%"></stop>
                  <stop stopColor="#8a8a9a" offset="50%"></stop>
                </linearGradient>
                <linearGradient id="searchl">
                  <stop stopColor="#8a8a9a" offset="0%"></stop>
                  <stop stopColor="#5a5a6a" offset="50%"></stop>
                </linearGradient>
              </defs>
            </svg>
          </div>
